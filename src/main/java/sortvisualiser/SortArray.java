package main.java.sortvisualiser;
...
import main.java.sortvisualiser.algorithms.ISortAlgorithm;
import main.java.sortvisualiser.screens.MainMenuScreen;
...
public class SortArray extends JPanel {
    ...
    public SortArray(boolean playSounds) {
        setBackground(MainMenuScreen.BACKGROUND_COLOUR);
